...
public interface UserHasPermissionDao extends GenericDao<UserHasPermission,Integer>{
	...
	public String findAllPermissionByUserIdAndUserType="from com.icat.antrance.model.UserHasPermission userHasPermission where "
	...
	public String findAllPermissionByUserIdAndUserTypeExamId="from com.icat.antrance.model.UserHasPermission userHasPermission where "
			+ "userHasPermission.userId =:_1_userId and userHasPermission.userType =:_2_userType and " +
	...
	public String findAllByExamIdAndUserId="from com.icat.antrance.model.UserHasPermission userHasPermission where "
	...
	public String findAllPermissions="from com.icat.antrance.model.UserHasPermission userHasPermission where " +
