...
public interface ExamSectionHasQuestionDao extends GenericDao<ExamSectionHasQuestion,Integer>{
	...
	public String findAllBySearchKeyWithFilter="from com.icat.antrance.model.ExamSectionHasQuestion examSectionHasQuestion where "
	...
	public String findAllByFilter="from com.icat.antrance.model.ExamSectionHasQuestion examSectionHasQuestion where examSectionHasQuestion.active =:_1_active order by examSectionHasQuestion.examSectionHasQuestionId desc";
	public String findAllBySearchKey="from com.icat.antrance.model.ExamSectionHasQuestion examSectionHasQuestion where examSectionHasQuestion.examSectionHasQuestionName like :_2_examSectionHasQuestionName order by examSectionHasQuestion.examSectionHasQuestionId desc";
	public String findAll = "from com.icat.antrance.model.ExamSectionHasQuestion examSectionHasQuestion order by examSectionHasQuestion.examSectionHasQuestionId desc";
	public String findAllBySectionId = "from com.icat.antrance.model.ExamSectionHasQuestion examSectionHasQuestion where examSectionHasQuestion.examSection.examSectionId= :_1_examSectionId and examSectionHasQuestion.active = true";
	public String findAllByExamId = "select new com.icat.antrance.model.ExamSectionHasQuestion(examSectionHasQuestion.examSectionHasQuestionId, examSectionHasQuestion.questionBank, examSectionHasQuestion.questionNumber,examSectionHasQuestion.marks, examSectionHasQuestion.negativeMark) from com.icat.antrance.model.ExamSectionHasQuestion examSectionHasQuestion where examSectionHasQuestion.examSection.exam.examId= :_1_examId and examSectionHasQuestion.active = true and examSectionHasQuestion.examSection.active=true";
	
	public String findAllShortResultBySectionId = "select new com.icat.antrance.model.ExamSectionHasQuestion(examSectionHasQuestion.examSectionHasQuestionId,examSectionHasQuestion.questionNumber, examSectionHasQuestion.marks, examSectionHasQuestion.active) from com.icat.antrance.model.ExamSectionHasQuestion examSectionHasQuestion where examSectionHasQuestion.examSection.examSectionId= :_1_examSectionId and examSectionHasQuestion.active = true";
