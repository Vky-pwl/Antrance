...
public interface CandidateDao extends GenericDao<Candidate,Integer>{
	...
	public String findUserLogin="from com.icat.antrance.model.Candidate user where user.active is true and (user.contactEmail=:_1_userName or user.contactNumber=:_1_userName)";
	...
	public String findAll="from com.icat.antrance.model.Candidate user";
